...
class _MyJournyState extends State<MyJourny> {
  ...
  List<String> content = [
    ...
    "他很少会去参加这类的游戏，但鉴于辛苦的一年终于结束了，去玩玩也何尝不可？\n旺盛的好胜心不允许他失败，于是他就赢得了这件深有纪念意义的T恤衫。",
    ...
    "他知道，能回母校的机会不会很多，于是乘着闲暇跑回那个他曾经奋斗了三年的地方。\n去找了他的老师叙叙旧，顺便蹭了一顿饭。\n”国际部的标志还是那么花哨，真是一点都没变啊”",
    ...
    "乘着冬假，他又跑到滑铁卢去看望他的老朋友。在这个弹丸之地，雪很大，风也很大。不由得扣紧了上衣。",
